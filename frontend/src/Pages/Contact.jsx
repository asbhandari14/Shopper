        ...
        <div className="contact_section w-full h-[100vh] flex justify-center items-center my-12">
            <div className="container w-[95%] h-full grid grid-cols-[1.5fr_2fr]">
                <div className=" flex flex-col justify-start items-start gap-6 p-8">
                    <h1 className="text-4xl font-bold " style={{color : (props.mode === "black")?"white":"black"}}>Need additional information ?</h1>
                ...
                <div className=" w-full h-full flex flex-col justify-start items-start p-8 " style={{color : (props.mode === "black")?"white":"black"}}>
